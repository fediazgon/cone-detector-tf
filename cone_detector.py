...
VIDEO_PATH = 'raw/sample_video.mp4'
...
# TUNE ME
CROP_WIDTH = CROP_HEIGHT = 400
CROP_STEP_HORIZONTAL = CROP_STEP_VERTICAL = 400 - 20  # Let's suppose no cone is bigger than 20 pixels
SCORE_THRESHOLD = 0.5
    ...
    with tf.Session(graph=detection_graph) as sess:
        ...
        while cap.isOpened():
            ...
            if ret:
                ...
                # crops are actual images as a numpy arrays of shape (number_crops, CROP_HEIGHT, CROP_WIDTH, 3)
                ...
                if OUTPUT_WINDOW_WIDTH:
                    frame = cv_utils.resize_width_keeping_aspect_ratio(frame, OUTPUT_WINDOW_WIDTH)
                ...
                logging.debug('Detected {} objects in {} images in {:.2f} ms'.format(
